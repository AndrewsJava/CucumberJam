...
public class CukeStepChoicePanel_Id extends JPanel {

 	final ArrayList<Component> stepBuilder = new ArrayList<Component>();
 	public static  ArrayList<JComboBox> choices_id = new ArrayList<JComboBox	>(); 
	public CukeStepChoicePanel_Id(String[] labels ) {
		...
		//	 patch(input);
			...
			this.add(pre);
			this.add(input);
			choices_id.add(input);
		}  
		 
		//remove last textarea
		this.remove(input);
		choices_id.remove(input);
